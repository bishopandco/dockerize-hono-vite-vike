Generated with [Bati](https://batijs.dev) ([version 276](https://www.npmjs.com/package/create-bati/v/0.0.276)) using this command:

```sh
npm create bati -- --vue --tailwindcss --hono --google-analytics --eslint --prettier
```
